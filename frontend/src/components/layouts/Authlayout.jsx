...
import CARD_2 from "../../assets/images/Card.jpeg";
...
const Authlayout = ({ children }) => {
  return  <div className="flex">
      ...
      <div className="hidden lg:block w-[50vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <img
          src={CARD_2}
          className=" h-[60vh] w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15"
        />
      </div>
    </div>
